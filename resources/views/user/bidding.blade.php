        ...
        <div id="products" class="table-responsive margin-top-50">
			...
			@csrf
                <div class="form-group">
                  ...
                  <input id="bid_cost" type="text" class="form-control" id="exampleInputEmail1">
                  ...
                  <input id="start_cost" type="text" class="form-control" placeholder="ex:5000元">

                  <label for="exampleInputEmail1">停止價格</label>
                  <input id="stop_cost" type="text" class="form-control" placeholder="ex:15000元">

                  <label for="exampleInputEmail1">每次金額</label>
                  <input id="per_cost" type="text" class="form-control" placeholder="ex:1000元">

                  <label for="exampleInputEmail1">次數</label>
                  <input id="times" type="text" class="form-control" placeholder="ex:10次">
